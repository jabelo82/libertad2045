...
# --------------------------------------------------
# Filtro sectorial — Experimento 34
# Limita el número de posiciones simultáneas por sector GICS.
# Se prueba con MAX_POR_SECTOR = 2 y MAX_POR_SECTOR = 3.
# --------------------------------------------------
MAX_POR_SECTOR = int(os.getenv("SECTOR_MAX", "2"))  # Cambiar a 3 para segunda prueba
...
# ==================================================
# MAPA DE SECTORES GICS
# ==================================================

SECTOR_MAP = {
    "AAPL":"Tecnología","MSFT":"Tecnología","NVDA":"Tecnología","AVGO":"Tecnología",
    "ORCL":"Tecnología","CRM":"Tecnología","AMD":"Tecnología","QCOM":"Tecnología",
    "TXN":"Tecnología","AMAT":"Tecnología","LRCX":"Tecnología","ADI":"Tecnología",
    "KLAC":"Tecnología","SNPS":"Tecnología","CDNS":"Tecnología","MRVL":"Tecnología",
    "MU":"Tecnología","NXPI":"Tecnología","ON":"Tecnología","MSI":"Tecnología",
    "KEYS":"Tecnología","FTNT":"Tecnología","PTC":"Tecnología","CDW":"Tecnología",
    "ZBRA":"Tecnología","NTAP":"Tecnología","HPQ":"Tecnología","HP":"Tecnología",
    "IBM":"Tecnología","CSCO":"Tecnología","INTU":"Tecnología","ADBE":"Tecnología",
    "ANET":"Tecnología","AKAM":"Tecnología","FFIV":"Tecnología","TRMB":"Tecnología",
    "TER":"Tecnología","ENPH":"Tecnología","DXC":"Tecnología","EPAM":"Tecnología",
    "GEN":"Tecnología","NOW":"Tecnología","TDG":"Tecnología",
    "UNH":"Salud","LLY":"Salud","JNJ":"Salud","ABBV":"Salud","MRK":"Salud",
    "TMO":"Salud","ABT":"Salud","DHR":"Salud","AMGN":"Salud","BSX":"Salud",
    "ISRG":"Salud","SYK":"Salud","VRTX":"Salud","REGN":"Salud","GILD":"Salud",
    "MDT":"Salud","BDX":"Salud","EW":"Salud","HCA":"Salud","DXCM":"Salud",
    "IQV":"Salud","ZBH":"Salud","IDXX":"Salud","BAX":"Salud","RMD":"Salud",
    "HOLX":"Salud","TECH":"Salud","PODD":"Salud","ALGN":"Salud","CRL":"Salud",
    "MTD":"Salud","WAT":"Salud","A":"Salud","ILMN":"Salud","SRPT":"Salud",
    "HSIC":"Salud","MCK":"Salud","COR":"Salud","CAH":"Salud","CVS":"Salud",
    "CI":"Salud","TFX":"Salud","XRAY":"Salud","VTRS":"Salud","PRGO":"Salud",
    "PFE":"Salud","BMY":"Salud","BIO":"Salud","STE":"Salud",
    "JPM":"Financiero","BAC":"Financiero","WFC":"Financiero","GS":"Financiero",
    "MS":"Financiero","BLK":"Financiero","SCHW":"Financiero","AXP":"Financiero",
    "AON":"Financiero","ICE":"Financiero","CME":"Financiero","SPGI":"Financiero",
    "MCO":"Financiero","USB":"Financiero","PNC":"Financiero","TFC":"Financiero",
    "MTB":"Financiero","FITB":"Financiero","HBAN":"Financiero","RF":"Financiero",
    "CFG":"Financiero","KEY":"Financiero","ZION":"Financiero","FHN":"Financiero",
    "PRU":"Financiero","MET":"Financiero","AFL":"Financiero","AIG":"Financiero",
    "ALL":"Financiero","TRV":"Financiero","HIG":"Financiero","GL":"Financiero",
    "LNC":"Financiero","UNM":"Financiero","RGA":"Financiero","AIZ":"Financiero",
    "AJG":"Financiero","WRB":"Financiero","ACGL":"Financiero","PFG":"Financiero",
    "AMP":"Financiero","SYF":"Financiero","COF":"Financiero","ALLY":"Financiero",
    "MA":"Financiero","V":"Financiero","MKTX":"Financiero","MSCI":"Financiero",
    "CBOE":"Financiero","FDS":"Financiero","NDAQ":"Financiero","BR":"Financiero",
    "C":"Financiero",
    ...
    "SBUX":"Consumo Discrecional","TJX":"Consumo Discrecional","BKNG":"Consumo Discrecional",
    "CMG":"Consumo Discrecional","ORLY":"Consumo Discrecional","AZO":"Consumo Discrecional",
    "MAR":"Consumo Discrecional","HLT":"Consumo Discrecional","RCL":"Consumo Discrecional",
    "CCL":"Consumo Discrecional","DAL":"Consumo Discrecional","UAL":"Consumo Discrecional",
    "LUV":"Consumo Discrecional","ALK":"Consumo Discrecional","BBY":"Consumo Discrecional",
    "EBAY":"Consumo Discrecional","ETSY":"Consumo Discrecional","EXPE":"Consumo Discrecional",
    "QSR":"Consumo Discrecional","YUM":"Consumo Discrecional","DRI":"Consumo Discrecional",
    "DHI":"Consumo Discrecional","LEN":"Consumo Discrecional","NVR":"Consumo Discrecional",
    "PHM":"Consumo Discrecional","TOL":"Consumo Discrecional","APTV":"Consumo Discrecional",
    "BWA":"Consumo Discrecional","LKQ":"Consumo Discrecional","KMX":"Consumo Discrecional",
    "POOL":"Consumo Discrecional","ROST":"Consumo Discrecional","DG":"Consumo Discrecional",
    "DLTR":"Consumo Discrecional","MHK":"Consumo Discrecional",
    "WMT":"Consumo Básico","PG":"Consumo Básico","KO":"Consumo Básico",
    "PEP":"Consumo Básico","COST":"Consumo Básico","PM":"Consumo Básico",
    "MO":"Consumo Básico","MDLZ":"Consumo Básico","CL":"Consumo Básico",
    "KMB":"Consumo Básico","CHD":"Consumo Básico","CLX":"Consumo Básico",
    "SJM":"Consumo Básico","MKC":"Consumo Básico","HRL":"Consumo Básico",
    "GIS":"Consumo Básico","CAG":"Consumo Básico","KHC":"Consumo Básico",
    "MNST":"Consumo Básico","BG":"Consumo Básico","MOS":"Consumo Básico",
    "SMG":"Consumo Básico","AVY":"Consumo Básico","SON":"Consumo Básico","SEE":"Consumo Básico",
    "CAT":"Industrial","HON":"Industrial","UNP":"Industrial","RTX":"Industrial",
    "LMT":"Industrial","DE":"Industrial","GE":"Industrial","MMM":"Industrial",
    "ITW":"Industrial","EMR":"Industrial","ETN":"Industrial","PH":"Industrial",
    "ROK":"Industrial","FTV":"Industrial","IR":"Industrial","CMI":"Industrial",
    "AME":"Industrial","HUBB":"Industrial","SWK":"Industrial","PNR":"Industrial",
    "XYL":"Industrial","NDSN":"Industrial","IEX":"Industrial","ROP":"Industrial",
    "OTIS":"Industrial","CARR":"Industrial","GD":"Industrial","NOC":"Industrial",
    "LII":"Industrial","TXT":"Industrial","LDOS":"Industrial","SAIA":"Industrial",
    "ODFL":"Industrial","JBHT":"Industrial","EXPD":"Industrial","CHRW":"Industrial",
    "XPO":"Industrial","GXO":"Industrial","UPS":"Industrial","FDX":"Industrial",
    "CTAS":"Industrial","FAST":"Industrial","GWW":"Industrial","WST":"Industrial",
    "PKG":"Industrial","IP":"Industrial","MAS":"Industrial","SNA":"Industrial","NVT":"Industrial",
    "XOM":"Energía","CVX":"Energía","COP":"Energía","EOG":"Energía","SLB":"Energía",
    "MPC":"Energía","PSX":"Energía","VLO":"Energía","OXY":"Energía","DVN":"Energía",
    "FANG":"Energía","HAL":"Energía","BKR":"Energía","APA":"Energía","NOV":"Energía",
    "FTI":"Energía","CVI":"Energía","NRG":"Energía",
    "LIN":"Materiales","APD":"Materiales","SHW":"Materiales","ECL":"Materiales",
    "FCX":"Materiales","NEM":"Materiales","NUE":"Materiales","DOW":"Materiales",
    "DD":"Materiales","PPG":"Materiales","IFF":"Materiales","ALB":"Materiales",
    "CE":"Materiales","EMN":"Materiales","FMC":"Materiales","CF":"Materiales",
    "WLK":"Materiales","RS":"Materiales",
    "NEE":"Utilities","SO":"Utilities","DUK":"Utilities","D":"Utilities",
    "SRE":"Utilities","AEP":"Utilities","EXC":"Utilities","XEL":"Utilities",
    "PCG":"Utilities","ED":"Utilities","EIX":"Utilities","ETR":"Utilities",
    "PPL":"Utilities","DTE":"Utilities","FE":"Utilities","CMS":"Utilities",
    "AEE":"Utilities","NI":"Utilities","LNT":"Utilities","EVRG":"Utilities",
    "PNW":"Utilities","AES":"Utilities","WEC":"Utilities","CNP":"Utilities",
    "PLD":"Inmobiliario","AMT":"Inmobiliario","EQIX":"Inmobiliario","CCI":"Inmobiliario",
    "PSA":"Inmobiliario","WELL":"Inmobiliario","DLR":"Inmobiliario","SPG":"Inmobiliario",
    "O":"Inmobiliario","SBAC":"Inmobiliario","AVB":"Inmobiliario","EQR":"Inmobiliario",
    "ESS":"Inmobiliario","MAA":"Inmobiliario","UDR":"Inmobiliario","CPT":"Inmobiliario",
    "INVH":"Inmobiliario","AMH":"Inmobiliario","EXR":"Inmobiliario","CUBE":"Inmobiliario",
    "REXR":"Inmobiliario","STAG":"Inmobiliario","NNN":"Inmobiliario","BXP":"Inmobiliario",
    "ARE":"Inmobiliario","FRT":"Inmobiliario","KIM":"Inmobiliario","REG":"Inmobiliario",
    "RHP":"Inmobiliario","IRM":"Inmobiliario","VTR":"Inmobiliario",
    "GOOGL":"Comunicaciones","GOOG":"Comunicaciones","META":"Comunicaciones",
    "NFLX":"Comunicaciones","DIS":"Comunicaciones","CMCSA":"Comunicaciones",
    "T":"Comunicaciones","VZ":"Comunicaciones","TMUS":"Comunicaciones",
    "CHTR":"Comunicaciones","WBD":"Comunicaciones","FOXA":"Comunicaciones",
    "NWS":"Comunicaciones","OMC":"Comunicaciones",
}

def obtener_sector(symbol):
    return SECTOR_MAP.get(symbol.upper(), "Desconocido")


def filtrar_por_sector_bt(señales, posiciones):
    """
    Filtra señales para garantizar diversificación sectorial.
    Descarta señales cuyo sector ya tiene MAX_POR_SECTOR posiciones abiertas.
    """
    conteo = {}
    for sym in posiciones:
        s = obtener_sector(sym)
        conteo[s] = conteo.get(s, 0) + 1

    aceptadas = []
    for señal in señales:
        sector = obtener_sector(señal["symbol"])
        if conteo.get(sector, 0) < MAX_POR_SECTOR:
            aceptadas.append(señal)
...
def ejecutar_backtest(datos, composicion_df=None):
    ...
    for fecha in fechas:
        ...
        # --------------------------------------------------
        # Filtro sectorial — Experimento 34
        # Limita entradas por sector según MAX_POR_SECTOR
        # --------------------------------------------------
        señales = filtrar_por_sector_bt(señales, posiciones)
...
if __name__ == "__main__":
    ...
    print(f"  Sector max   : {MAX_POR_SECTOR} posiciones por sector")
